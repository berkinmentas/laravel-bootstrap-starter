        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid d-flext align-items-center justify-content-between ">
                <a class="nav-item-logo-image mx-5 " href="/"><img
                        src="{{\Illuminate\Support\Facades\Vite::asset('resources/images/logo.png')}}" alt=""></a>
                <div class="d-flex align-items-center justify-content-center" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/">{{__('Homepage')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/">{{__('Homepage')}}</a>
                        </li>
...
<div class="page-loader">
    <div class="page-loader-img ">
        <img class="img-fluid mb-3" src="{{\Illuminate\Support\Facades\Vite::asset('resources/images/logo.png')}}"
             alt="Logo"/>
